...
\mbox{[}riquadro\+\_\+t\mbox{]} -\/ enumeratore che indica la singola casella del campo di gioco \mbox{[}$\ast$ campo \+\_\+ di \+\_\+ gioco\mbox{]} -\/ putatore che punta alla struttura sopra \mbox{[}I\+\_\+90\mbox{]} -\/ esempio di tetramino, ogni tetramino è un vettore di 4 elementi.
